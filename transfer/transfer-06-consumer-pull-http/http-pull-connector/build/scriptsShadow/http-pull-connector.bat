...
set CLASSPATH=%APP_HOME%\lib\http-pull-connector.jar

@rem Execute http-pull-connector
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HTTP_PULL_CONNECTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HTTP_PULL_CONNECTOR_EXIT_CONSOLE%" exit 1
exit /b 1
